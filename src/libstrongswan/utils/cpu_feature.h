...
typedef enum {
	...
	CPU_FEATURE_PADLOCK_RNG_AVAILABLE =			(1 << 11),
	CPU_FEATURE_PADLOCK_RNG_ENABLED =			(1 << 12),
	CPU_FEATURE_PADLOCK_ACE_AVAILABLE =			(1 << 13),
	CPU_FEATURE_PADLOCK_ACE_ENABLED =			(1 << 14),
	CPU_FEATURE_PADLOCK_ACE2_AVAILABLE =		(1 << 15),
	CPU_FEATURE_PADLOCK_ACE2_ENABLED =			(1 << 16),
	CPU_FEATURE_PADLOCK_PHE_AVAILABLE =			(1 << 17),
	CPU_FEATURE_PADLOCK_PHE_ENABLED =			(1 << 18),
	CPU_FEATURE_PADLOCK_PMM_AVAILABLE =			(1 << 19),
	CPU_FEATURE_PADLOCK_PMM_ENABLED =			(1 << 20),
} cpu_feature_t;
